...
class pythonProgramOptions:
    ...
    def __init__(self, config_file='compasConfig.yaml', grid_filename=None, random_seed_filename='randomSeed.txt', output_directory=None):
        ...
        # Addition Lieke: never add options to sysparams (too much space)
        # { ALWAYS, GRID, NEVER }, keep at GRID for the first run if you want to produce sys params like kick values
        self.stringChoices['--add-options-to-sysparms'] = 'NEVER'
